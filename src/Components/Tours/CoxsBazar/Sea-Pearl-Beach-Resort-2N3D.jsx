     ...
     <div className='singlepack container section'>
	       ...
	       <div className='imageContainer sflex'>
                    ...
                    <div className='middleImage'>
                        <img src={SeaPearl_1} className='destinationImage'/>
                    </div>
...
export default SeaPearlBeachResort2N3D
