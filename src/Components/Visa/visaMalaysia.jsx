...
const VisaMalaysia = () =>{
   return(
	 ...
	 <div className='singleText'>
	    <h1>Required Documents for visa (Malaysia) </h1>
	    <span>
	        <h3>Basic Documents</h3>
	        <p>07 Months Valid Passport With Old Passport (If have)</p>
	        <p>Recent 2 copy photograph taken in last 3 months (white background only, photo size 35 mm X 50 mm)</p>
	        <p>Personal bank statement of last 06 months and minimum balance BDT 80,000 for each applicant.</p>
	        <p>Visiting card</p>
